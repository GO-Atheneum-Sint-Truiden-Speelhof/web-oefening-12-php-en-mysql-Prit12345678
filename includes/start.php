<?php
    ...
    echo '<div class="row"><div class="col tegel"><p>Je hebt deze website het laatst bezocht op '.$_COOKIE[$c_naam].'.</p></div>
    </div>';
    } else {
    echo '<div class="row"><div class="col tegel"><p>Je hebt dezewebsite de laatste drie maanden niet be-zocht.</p></div></div>';
    }
?>
